...
Env_.src = function() end 
Env_.link = function() end 
Env_.href = function() end 
Env_.style = function() end 
Env_.class = function() end 

Env_.head = function () end 
Env_.body = function () end 
Env_.leaf = function () end 
Env_.branch = function () end 
Env_.mouse = function () end 
Env_.styleFile = function () end 
Env_.funFile = function () end 
